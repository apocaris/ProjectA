...
public class UILabel : UIWidget
{
	...
	private SystemLanguage m_eLanguage = SystemLanguage.Korean;
	protected override void OnEnable ()
	{
        ...
        {
            //재활성화 되었을 때 언어 변경되었다면 다시 불러오기
            //if (m_eLanguage == G_UserDataMGR.a_instance.a_eSystemLanguage)
            //    return;
            //else
            //{
            //    ChangeFontByLanguage();
            //    m_eLanguage = G_UserDataMGR.a_instance.a_eSystemLanguage;
            //}
        }
	}
#endif
    ...
    private void ChangeFontByLanguage()
    {
        if (Application.isPlaying)
        {
            //언어에 따른 폰트 변경 2022.10.06
			//SystemLanguage eLang = G_UserDataMGR.a_instance.a_eSystemLanguage;
			/* switch (eLang)
			{
				...
				case SystemLanguage.ChineseSimplified:
					...
					{
						if (trueTypeFont != G_UIBase.m_vGlobalFont)
							trueTypeFont = G_UIBase.m_vGlobalFont;
					}
					break;
				default:
					if (G_UIBase.m_vKorFont != null)
					{
						if ((UnityEngine.Object)bitmapFont != G_UIBase.m_vKorFont)
							bitmapFont = G_UIBase.m_vKorFont;
					}
					break;
			} */
        }
