...
public class UIPanel : UIRect
{
    ...
    private void FixedUpdate()
    {
		...
		//	if (m_vUICamera == null)
		//		m_vUICamera = GameObject.Find(G_Constant.m_strSceneMGR).GetComponent<G_UISceneBase>().a_vUICamera;

		//	if (m_fAspect != m_vUICamera.aspect)
		//	{
		//		//비율이 변하면 Panel 갱신
		//		m_fAspect = m_vUICamera.aspect;
		//		int iWidth = (int)(G_Constant.m_iScreenResoultion * m_fAspect);
		//		int iHeight = G_Constant.m_iScreenResoultion;

		//		if (iWidth <= 1000)
		//		{
		//			iWidth = (int)(G_Constant.m_iFoldScreenResoultion * m_fAspect);
		//			iHeight = G_Constant.m_iFoldScreenResoultion;
		//		}
